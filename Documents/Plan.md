...
* Номер валидной карты : "3333 3333 3333 3331" статус карты "Одобрено"
* Номер не валидной карты: "3333 3333 3333 3332" статус карты "Отклонено"
...
### UI тесты
#### Оплата по карте
1. **Карта со статусом "Одобрено", все поля формы покупки валидные** 
* Нажать на кнопку "Купить"
* Во всех полях ввести валидные данные: номер карты 3333 3333 3333 3331
* Нажать на кнопку "Продолжить"
**Ожидаемый результат:** форма отправилась успешно, сообщение - "Успешно. Операция одобрена банком!"

2. **Карта со статусом "Отклонено", все поля формы покупки валидные**
* Нажать на кнопку "Купить"
* Во всех полях ввести валидные данные: номер карты 3333 3333 3333 3332
* Нажать на кнопку "Продолжить"
**Ожидаемый результат:** отправка формы выполнена успешно, сообщение - "Ошибка! Банк отказал в проведении операции!"
